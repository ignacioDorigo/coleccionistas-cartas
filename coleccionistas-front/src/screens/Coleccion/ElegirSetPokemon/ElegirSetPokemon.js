        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    text: "ACEPTO",
                    onPress: () => {
                        axios.post(`http://192.168.1.14:8080/coleccionistas/crearColeccion?mail=${mail}&idMazo=${mazo.id}&idColeccion=${coleccion.id}`)
                            .then(response => navigation.navigate(screen.coleccion.cartasSet, { coleccion, mazo }))
